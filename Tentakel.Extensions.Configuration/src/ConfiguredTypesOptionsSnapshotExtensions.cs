...
namespace Tentakel.Extensions.Configuration
{
    public static class ConfiguredTypesOptionsSnapshotExtensions
    {
        ...
        {
            return configuredTypesOptionsSnapshot.GetKeys<TOptions>().Select(configuredTypesOptionsSnapshot.Get<TOptions>).ToList();
        }
        ...
        {
            return configuredTypesOptionsSnapshot.GetKeys().Select(configuredTypesOptionsSnapshot.Get).ToList();
        }
    }
}