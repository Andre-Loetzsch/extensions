...
namespace Tentakel.Extensions.Configuration.Json.Test
{
    [TestClass]
    public class ConfiguredTypesConfigurationTest
    {
        ...
        public void TestMergedConfigurations()
        {
            ...
            configuration2.Set("NC1", new NestedClass
            {
                ...
                C1 = new Class1 { Property1 = "P1" },
                C2 = new Class2 { Property2 = "P2" },

                Sub = new NestedClass
                {
                    C1 = new Class1 { Property1 = "SUB1:P1" },
                    C2 = new Class2 { Property2 = "SUB1:P2" },
                }
        ...
        public void TestCreateJsonStringFromConfiguredTypes()
        {
            ...
            dict = new Dictionary<string, object>(configuredTypes
